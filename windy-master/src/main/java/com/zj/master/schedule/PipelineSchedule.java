  ...
  public void run(String... args) throws Exception {
    ...
    pipelines.forEach(pipeline -> {
      ...
      taskScheduler.schedule(() -> {
        ...
        taskDetailDto.setType(LogType.PIPELINE.getType());
        taskDetailDto.setSourceName(pipeline.getPipelineName());
        taskDetailDto.setSourceId(pipeline.getPipelineId());
        taskLogService.createTask(taskDetailDto);
      }, trigger);
    });
  }
}
