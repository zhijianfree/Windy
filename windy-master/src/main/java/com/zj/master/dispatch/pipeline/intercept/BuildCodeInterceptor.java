...
public class BuildCodeInterceptor implements INodeExecuteInterceptor {
  ...
  public BuildCodeInterceptor(IPipelineNodeRepository pipelineNodeRepository,
                              ...
                              IBindBranchRepository gitBindRepository, ISystemConfigRepository configRepository, IMicroServiceRepository microServiceRepository) {
  ...
  public void beforeExecute(TaskNode taskNode) {
    ...
    if (Objects.equals(pipeline.getPipelineType(), PipelineType.PUBLISH.getType())) {
      ...
      rebuildRequestContext(taskNode, branches, repository, true, serviceConfig);
      return;
    }
    ...
    rebuildRequestContext(taskNode, Collections.singletonList(bindBranch.getGitBranch()),
        repository, false, serviceConfig);
  }

  private void rebuildRequestContext(TaskNode taskNode, List<String> branches,
                                     ImageRepositoryVo repository, boolean isPublish, ServiceConfig serviceConfig) {
