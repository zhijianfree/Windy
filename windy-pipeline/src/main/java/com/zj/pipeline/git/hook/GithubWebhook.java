...
public class GithubWebhook extends AbstractWebhook{
  ...
  public GithubWebhook(MicroserviceService microserviceService, PipelineService pipelineService,
  ...
  public GitParseResult parseData(Object data) {
    ...
    GithubHookVo giteaHookVo = JSON.parseObject(JSON.toJSONString(data), GithubHookVo.class);
