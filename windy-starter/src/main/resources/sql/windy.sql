...
VALUES
    ...
    (3,'71a26960299f49c3aa26b687ea2fbdba',1,'com.zj.client.handler.feature.ability.mysql.MysqlFeature','executeQuery','mysql查询','admin','执行mysql语句',NULL,'[{\"defaultValue\":{\"defaultValue\":\"\"},\"description\":\"mysql连接地址\",\"paramKey\":\"connect\",\"type\":0},{\"defaultValue\":{\"defaultValue\":\"\"},\"description\":\"数据库名称\",\"paramKey\":\"dbName\",\"type\":0},{\"defaultValue\":{\"defaultValue\":\"\"},\"description\":\"数据库用户\",\"paramKey\":\"user\",\"type\":0},{\"defaultValue\":{\"defaultValue\":\"\"},\"description\":\"用户密码\",\"paramKey\":\"password\",\"type\":0},{\"defaultValue\":{\"defaultValue\":\"\"},\"description\":\"执行的sql\",\"paramKey\":\"sql\",\"type\":0}]',1,'{}',1670927202853,1692542168926),
