...
CREATE TABLE `service_api` (
  ...
  `type` varchar(10) NOT NULL COMMENT 'api类型 http dubbo',
  `method` varchar(100) NOT NULL COMMENT 'api对应的方法 http对应方法名 dubbo对应接口方法名',
  `api` varchar(256) NOT NULL COMMENT 'api信息http对应的url dubbo对应服务名',
