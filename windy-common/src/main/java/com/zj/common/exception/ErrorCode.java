...
public enum ErrorCode {
  ...
  SPACE_HAS_NOT_COMPLETE_ITERATION(HttpStatus.BAD_REQUEST, "Demand.000006", "空间下有未完成的迭代无法删除"),
  SPACE_HAS_NOT_COMPLETE_DEMAND(HttpStatus.BAD_REQUEST, "Demand.000007", "空间下有未完成的需求"),
  SPACE_HAS_NOT_COMPLETE_BUG(HttpStatus.BAD_REQUEST, "Demand.000008", "空间下有未完成的bug无法删除"),
  ITERATION_HAS_NOT_COMPLETE_DEMAND(HttpStatus.BAD_REQUEST, "Demand.000009", "迭代下有未完成的需求"),
  ITERATION_HAS_NOT_COMPLETE_BUG(HttpStatus.BAD_REQUEST, "Demand.000010", "迭代下有未完成的bug无法删除"),
  /*==================Client端构建运行==================*/
